...
for (i in seq_along(params$year)) {
  ...
  mat_files <- list.files(class_folder, pattern = "\\.mat$", full.names = TRUE)
  ...
  shark_df <- shark_col %>%
    mutate(MYEAR = data_aggregated_year$year,
           ...
           METDC = paste("https://github.com/hsosik/ifcb-analysis",
                         ...
                         sep = ", "), # METHOD
           TRAINING_SET_ANNOTATED_BY = ifelse(params$classifier == "Tangesund", "Malin Mohlin", "Ann-Turi Skjevik"),
