...
date: "`r Sys.Date()`"
params: 
  classifier: "niva_smhi" # "Baltic", "Skagerrak-Kattegat", "Tangesund" or "Skagerrak-Kattegat-Tangesund"
...
for (i in seq_along(params$year)) {
  ...
  if (nrow(missing_position) > 0) {
    ferrybox_positions <- ifcb_get_ferrybox_data(missing_position$timestamp, 
                                                 ferrybox_path, 
                                                 ship = "SveaAWS",
